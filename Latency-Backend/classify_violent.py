...
# try:
#     classifier = pipeline("image-classification", model="jaranohaal/vit-base-violence-detection")
#     logger.info("Violence detection classifier loaded successfully")
...
#     """
#     Process video to detect violent content and overlay classification results
...
#     frame_count = 0
#     last_classification = {"label": "non-violence", "score": 0.0}
...
#             # Adjust these labels based on what the model actually returns
...
#     """Helper function to understand what labels the model returns"""
#     try:
#         # Create a test image and get results to see possible labels
#         test_image = Image.new('RGB', (224, 224), color='blue')
#         results = classifier(test_image)
#         labels = [result["label"] for result in results]
#         logger.info(f"Model returns these labels: {labels}")
#         return labels
#     except Exception as e:
#         logger.error(f"Failed to get model labels: {e}")
#         return []

# if __name__ == "__main__":
#     # Test the classifier and show available labels
#     print("Testing violence detection classifier...")
    
#     if test_classifier():
#         print("Classifier is working correctly!")
        
#         # Show what labels the model returns
#         print("\nAvailable labels from the model:")
